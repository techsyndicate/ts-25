  ...
  return (
    ...
    <div className="w-[20vw] h-[30vw] flex flex-col items-center mt-[4vh] bg-[#191919] rounded-[1vw] group relative ">
      <img
        src={image}
        alt={name}
        className="w-[25vw] aspect-square object-cover p-[2vw]"
      />
      <h2 className="text-[#fff] text-[2vw]">{name}</h2>
      <h4 className="text-[#8c8c8c] text-[1.4vw] group-hover:text-[#16e16e] transition-all duration-300">
        {title}
      </h4>
      <div
        id="socials"
        className="flex flex-row justify-center items-center bg-[#393939] rounded-[1vw] gap-[1.4vw] mt-[3vw] p-[1vw] px-[2.4vw] opacity-0 group-hover:opacity-100 transition-opacity duration-300"
      >
        {socialIcons.map((icon, index) => {
          ...
          return (
            ...
            >
              <FontAwesomeIcon
                icon={iconDefinition}
                className="text-[1.5vw] align-middle self-center"
              />
            </a>
          );
        })}
