...
const MemberCard: React.FC<MemberCardProps> = ({
  ...
  return (
    ...
    // <div className="sm:w-[19vw] sm:h-[27vw] w-[70vw] h-[100vw] flex flex-col items-center mt-[4vh] bg-[#191919] sm:rounded-[1vw] rounded-[4vw] group relative hover:scale-105 transition-all duration-300">
