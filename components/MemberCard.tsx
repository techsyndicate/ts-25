...
const MemberCard: React.FC<MemberCardProps> = ({
  ...
  return (
    ...
    <div className="sm:w-[19vw] sm:h-[30vw] w-[70vw] h-[100vw] flex flex-col items-center mt-[4vh] bg-[#191919] sm:rounded-[1vw] rounded-[4vw] group relative ">
      ...
      <div
        id="socials"
        className="flex flex-row justify-center items-center bg-[#393939] rounded-[4vw] gap-[4vw] mt-[5vw] p-[4vw] px-[7vw] sm:opacity-0 sm:group-hover:opacity-100 sm:transition-opacity sm:duration-300 sm:rounded-[1vw] sm:gap-[1.4vw] sm:mt-[3vw] sm:p-[1vw] sm:px-[2.4vw]"
      >
