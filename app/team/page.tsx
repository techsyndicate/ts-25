  ...
  return (
    <div className="overflow-y-auto no-scrollbar h-screen w-screen">
      <div className="flex items-center justify-center flex-col mb-[5vh]">
        ...
        >
          ALUMNI <img src="/rightArrow.png" className="sm:h-[0.9vw] h-[4vw]"></img>
        </button>
        <div className="sm:w-[80vw] flex sm:flex-row flex-col items-center justify-center sm:flex-wrap mt-[5vh] mb-[8vh] gap-[3vw] sm:wrap-anywhere">
